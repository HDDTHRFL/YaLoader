...
from yaloader.config.resources import get_app_icon_path
from yaloader.services.app_container import AppContainer
from yaloader.ui.font_loading import load_application_fonts
...
def run_gui_application(container: AppContainer) -> int:
    ...
    window = MainWindow(
        container=container,
        title_font_family=loaded_fonts.title_font_family,
    )
