...
FILE_COLUMN_INDEX: Final = 3
FORMAT_COLUMN_INDEX: Final = FILE_COLUMN_INDEX
STATUS_PROGRESS_COLUMN_INDEX: Final = 4
FOLDER_COLUMN_INDEX: Final = 5

STATUS_COLUMN_INDEX: Final = STATUS_PROGRESS_COLUMN_INDEX
PROGRESS_COLUMN_INDEX: Final = STATUS_PROGRESS_COLUMN_INDEX

QUEUE_COLUMN_COUNT: Final = 6
QUEUE_ROW_HEIGHT: Final = 54
TABLE_RIGHT_OVERDRAW_WIDTH: Final = 1

MIN_COLUMN_WIDTHS: Final[dict[int, int]] = {
    MODE_COLUMN_INDEX: 92,
    URL_COLUMN_INDEX: 280,
    QUALITY_COLUMN_INDEX: 112,
    FILE_COLUMN_INDEX: 90,
...
COLUMN_STRETCH_WEIGHTS: Final[dict[int, float]] = {
    ...
    QUALITY_COLUMN_INDEX: 0.45,
    FILE_COLUMN_INDEX: 0.35,
